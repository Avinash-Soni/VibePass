...
import com.VibePass.ticket.domain.entities.EventStatusEnum;
import com.VibePass.ticket.domain.entities.TicketType;
import com.VibePass.ticket.domain.entities.User;
import com.VibePass.ticket.exceptions.EventNotFoundException;
import com.VibePass.ticket.exceptions.EventUpdateException;
...
import com.VibePass.ticket.repositories.EventRepository;
...
public class EventServiceImpl implements EventService {
    ...
    public Page<Event> listEventsForOrganizer(UUID organizerId, Pageable pageable) {
        ...
        events.forEach(event -> {
            event.getTicketTypes().forEach(ticketType -> {
                ...
                ticketType.setRemainingTickets(ticketType.getTotalAvailable() - purchased);
            });
        });
    ...
    public Optional<Event> getPublishedEvent(UUID id) {
        Optional<Event> eventOpt = eventRepository.findByIdAndStatus(id, EventStatusEnum.PUBLISHED);
