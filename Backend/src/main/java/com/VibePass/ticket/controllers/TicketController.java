...
import com.VibePass.ticket.domain.entities.User; // ✅ Import User entity
import com.VibePass.ticket.mappers.TicketMapper;
import com.VibePass.ticket.services.QrCodeService;
import com.VibePass.ticket.services.TicketService;
...
public class TicketController {
    ...
    public Page<ListTicketResponseDto> listTickets(
        ...
        return ticketService.listTicketsForUser(
                user.getId(), // ✅ Direct access to ID
                pageable
